...
Feed lives at `/rss.xml`, linked in the homepage footer below Subscribe. Auto-regenerated by GitHub Actions whenever a file in `blog/` is pushed. To regenerate manually:
